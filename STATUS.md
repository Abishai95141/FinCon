...
| **Tests** | **810 offline** (`make test`) + live gates needing `DEEPSEEK_API_KEY`. **1 known-broken row** — `ReconException.leg` cannot name a side a second loop has. Contract **7.8.0**. |
